...
class BarangController extends Controller
{
    ...
    public function export_excel()
    {
        ...
        foreach ($barang as $data) {
            $sheet->setCellValue('A' . $baris, $data->barang_kode);
            $sheet->setCellValue('B' . $baris, $data->barang_nama);
            $sheet->setCellValue('C' . $baris, $data->harga_beli);
            $sheet->setCellValue('D' . $baris, $data->harga_jual);
            $sheet->setCellValue('E' . $baris, $data->kategori->kategori_nama);
            $sheet->setCellValue('F' . $baris, $data->supplier->supplier_nama);
            $baris++;
            $no++;
        }
