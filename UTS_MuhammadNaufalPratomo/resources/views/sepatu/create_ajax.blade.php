        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input value="" type="text" name="sepatu_kode" id="sepatu_kode" class="form-control" required>
                    <small id="error-sepatu_kode" class="error-text form-text text-danger"></small>
                </div>
                <div class="form-group">
                    <label>Nama Sepatu</label>
                    <input value="" type="text" name="sepatu_nama" id="sepatu_nama" class="form-control" required>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="display_harga_beli" value="" required
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="display_harga_jual" value="" required
